...
type GenerationLogConfig = Pick<AiConfig, "model" | "imageModel" | "quality" | "size" | "count" | "imageWatermark">;
...
export default function ImagePage() {
    ...
    const previewGenerationLog = async (log: GenerationLog) => {
        ...
        if (log.config.imageWatermark) updateConfig("imageWatermark", log.config.imageWatermark);
...
function normalizeLogConfig(log: Partial<GenerationLog>): GenerationLogConfig {
    return {
        ...
        imageWatermark: log.config?.imageWatermark || "false",
    };
}
