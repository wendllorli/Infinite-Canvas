export default {
    ...
    settingsPanels: {
        ...
        image: { title: "图像设置", quality: "质量", size: "尺寸", align16: "16 倍数对齐", align16Hint: "输入完成后自动向上补成 16 的倍数", aspectRatio: "宽高比", transparent: "透明背景", transparentHint: "开启后生成无背景的透明图像（仅部分模型可用）", watermark: "添加水印", watermarkHint: "火山方舟生图时生效", count: "生成张数", images: "{{count}} 张" },
