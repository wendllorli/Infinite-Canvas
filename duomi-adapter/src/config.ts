...
export function loadConfig(): AdapterConfig {
    return {
        ...
        authMode: authMode(),
        pollIntervalMs: positiveInteger("DUOMI_POLL_INTERVAL_MS", 2000),
        timeoutMs: positiveInteger("DUOMI_TIMEOUT_MS", 300000),
        imageModel: process.env.DUOMI_IMAGE_MODEL?.trim() || "gpt-image-2",
        videoModels: csv("DUOMI_VIDEO_MODELS", ["veo3.1-fast", "veo3.1-pro", "grok-video", "grok-video-1.5"]),
