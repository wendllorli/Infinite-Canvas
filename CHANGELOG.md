...
+ [新增] 火山方舟图片模型分别接入 doubao-seedream-5-0lite 与 doubao-seedream-5-0pro，支持文生图、单图编辑和多图参考，输出水印默认关闭。
+ [新增] 配置页新增“chatgpt-特价版”快捷渠道，连接独立 ChatGPT2API 服务并使用 gpt-image-2 生图与改图。
